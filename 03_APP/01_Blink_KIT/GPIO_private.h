...
typedef struct {                                                                                          
  ...
  volatile u32  MODER	  ;              !< GPIO Data                                                             
  volatile u32  OTYPER	;                < GPIO Direction                                                        
  volatile u32  OSPEEDR ;               !< GPIO Interrupt Sense                                                  
  volatile u32  PUPDR	  ;              *!< GPIO Interrupt Both Edges                                             
  volatile u32  IDR		  ;              *!< GPIO Interrupt Event                                                  
  volatile u32  ODR		  ;              *!< GPIO Interrupt Mask                                                   
  volatile u32  BSRR		;                *!< GPIO Raw Interrupt Status                                             
  volatile u32  LCKR		;                !< GPIO Masked Interrupt Status                                          
  volatile u32  AFRL		;                *!< GPIO Interrupt Clear                                                  
  volatile u32  AFRH		;                *!< GPIO Alternate Function Select                                        
