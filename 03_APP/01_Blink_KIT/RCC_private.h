...
************************************************************************************/
  #define RCC_Base_Address				0x40023800 
	...
	#define			 RCC_PLLCFGR					(*((volatile u32*) (RCC_Base_Address+0x04))) // RCC PLL configuration register (RCC_PLLCFGR)
	#define			 RCC_CFGR							(*((volatile u32*) (RCC_Base_Address+0x08))) // RCC clock configuration register (RCC_CFGR)
	#define			 RCC_CIR							(*((volatile u32*) (RCC_Base_Address+0x0C))) // RCC clock interrupt register (RCC_CIR)
	#define			 RCC_AHB1RSTR					(*((volatile u32*) (RCC_Base_Address+0x10))) // RCC AHB1 peripheral reset register (RCC_AHB1RSTR)
	#define			 RCC_AHB2RSTR					(*((volatile u32*) (RCC_Base_Address+0x14))) // RCC AHB2 peripheral reset register (RCC_AHB2RSTR)
	#define			 RCC_AHB3RSTR					(*((volatile u32*) (RCC_Base_Address+0x18))) // RCC AHB3 peripheral reset register (RCC_AHB3RSTR)
	#define			 RCC_APB1RSTR					(*((volatile u32*) (RCC_Base_Address+0x20))) // RCC APB1 peripheral reset register (RCC_APB1RSTR)
	#define			 RCC_APB2RSTR					(*((volatile u32*) (RCC_Base_Address+0x24))) // RCC APB2 peripheral reset register (RCC_APB2RSTR)
	#define			 RCC_AHB1ENR					(*((volatile u32*) (RCC_Base_Address+0x30))) // RCC AHB1 peripheral clock register (RCC_AHB1ENR)
	#define			 RCC_AHB2ENR					(*((volatile u32*) (RCC_Base_Address+0x34))) // RCC AHB2 peripheral clock enable register (RCC_AHB2ENR)
	#define			 RCC_AHB3ENR					(*((volatile u32*) (RCC_Base_Address+0x38))) // RCC AHB3 peripheral clock enable register (RCC_AHB3ENR)
	#define			 RCC_APB1ENR					(*((volatile u32*) (RCC_Base_Address+0x40))) // RCC APB1 peripheral clock enable register (RCC_APB1ENR)
	#define			 RCC_APB2ENR					(*((volatile u32*) (RCC_Base_Address+0x44))) // RCC APB2 peripheral clock enable register (RCC_APB2ENR)
	#define			 RCC_AHB1LPENR				(*((volatile u32*) (RCC_Base_Address+0x50))) // RCC AHB1 peripheral clock enable in low power mode register (RCC_AHB1LPENR)
	#define			 RCC_AHB2LPENR				(*((volatile u32*) (RCC_Base_Address+0x54))) // RCC AHB2 peripheral clock enable in low power mode register
	#define			 RCC_AHB3LPENR				(*((volatile u32*) (RCC_Base_Address+0x58))) // RCC AHB3 peripheral clock enable in low power mode register
	#define			 RCC_APB1LPENR				(*((volatile u32*) (RCC_Base_Address+0x60))) // RCC APB1 peripheral clock enable in low power mode register
	#define			 RCC_APB2LPENR				(*((volatile u32*) (RCC_Base_Address+0x64))) // RCC APB2 peripheral clock enabled in low power mode register
	#define			 RCC_BDCR							(*((volatile u32*) (RCC_Base_Address+0x70))) // RCC Backup domain control register (RCC_BDCR)
	#define			 RCC_CSR							(*((volatile u32*) (RCC_Base_Address+0x74))) // RCC clock control & status register (RCC_CSR)
	#define			 RCC_SSCGR						(*((volatile u32*) (RCC_Base_Address+0x80))) // RCC spread spectrum clock generation register (RCC_SSCGR)
	#define			 RCC_PLLI2SCFGR				(*((volatile u32*) (RCC_Base_Address+0x84))) // RCC PLLI2S configuration register (RCC_PLLI2SCFGR)
