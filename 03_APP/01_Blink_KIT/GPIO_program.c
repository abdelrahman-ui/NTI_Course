...
/*		Function Set The Mode Of Pin Mode Take 2Bits	
 ...
 void MGOIP_voidSetPinMode(u8 copy_u8PORT ,u8 copy_u8PIN,u8 copy_u8MODE) 
 {
	      ...
	      {
	  	    case  GPIOA :
	  	   			  GPIOA_MODER |= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	     break ;
	  	     /*******************/
	  	    case  GPIOB : 
	  	   			 GPIOB_MODER |= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	     break ;
	  	     /*******************/
	  	    case  GPIOC :
	  	    			 GPIOC_MODER |= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	      break ;
	  	      /*******************/
	  	    case  GPIOD :
	  	    			 GPIOD_MODER|= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	      break ;
	  	      /*******************/
	  	    case  GPIOE :
	  	    			 GPIOE_MODER|= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	      break ;
	  	      /*******************/
	  	    case  GPIOF : 
	  	    			 GPIOF_MODER|= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	     break ;
	  	     /*******************/
	  	    case  GPIOG : 
	  	    			 GPIOG_MODER|= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	     break ;
	  	     /*******************/
	  	    case  GPIOH : 
	  	    			 GPIOH_MODER|= (u32)(copy_u8MODE << (2U*copy_u8PIN));
	  	     break ;
	  	     /*******************/
			default : break ;
		 }
...
/********************************************************** Start_FUNCTION  **********************************************************/
/*		Function To Lock Pin : - Set bit 16
														 - Set pin
														 - wait bit 16 = high 
*/
...

{
	...
	else
	{
		  switch (copy_u8PORT)
		  {
			  ...
			  /*******************/
			  case  GPIOB :
			  GPIOB_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8U)));
			  break ;
			  /*******************/
			  case  GPIOC :
			  GPIOC_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8U)));
			  break  ;	
			  /*******************/
			  case  GPIOD :
			  GPIOD_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8U)));
			  break ;
			  /*******************/
			  case  GPIOE :
			  GPIOE_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8U)));
			  break ;
			  /*******************/
			  case  GPIOF :
			  GPIOF_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8)));
			  break ;
			  /*******************/
			  case  GPIOG :
			  GPIOG_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8)));
			  break ;
			  /*******************/
			  case  GPIOH :
			  GPIOH_AFRH|= (u32)(copy_u8AlT << (4U*(copy_u8PIN % 8)));
			  break ;
			  /*******************/
			  default : break ;
		  }
