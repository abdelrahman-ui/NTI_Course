		...
		u8 MGPIO_u8ReadData(u8 copy_u8PORT ,u8 copy_u8PIN)
{
			u8 u8Local_Data = 0 ;
		      ...
		      switch (copy_u8PORT)
		      {
			      case GPIOA_PORT: u8Local_Data = (u8) (GPIOA_IDR &(1U<<copy_u8PIN)); break;
						case GPIOB_PORT: u8Local_Data = (u8) (GPIOB_IDR &(1U<<copy_u8PIN)); break;
						case GPIOC_PORT: u8Local_Data = (u8) (GPIOC_IDR &(1U<<copy_u8PIN)); break;
						case GPIOD_PORT: u8Local_Data = (u8) (GPIOD_IDR &(1U<<copy_u8PIN)); break;
						case GPIOE_PORT: u8Local_Data = (u8) (GPIOE_IDR &(1U<<copy_u8PIN)); break;
						case GPIOF_PORT: u8Local_Data = (u8) (GPIOF_IDR &(1U<<copy_u8PIN)); break;
						case GPIOG_PORT: u8Local_Data = (u8) (GPIOG_IDR &(1U<<copy_u8PIN)); break;
						case GPIOH_PORT: u8Local_Data = (u8) (GPIOH_IDR &(1U<<copy_u8PIN)); break;		
						default: break;
...

{
	...
	if (copy_u8PIN <= 7)
	{
		     switch (copy_u8PORT)
		     {
			     case GPIOA_PORT: GPIOA_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOB_PORT: GPIOB_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOC_PORT: GPIOC_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOD_PORT: GPIOD_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOE_PORT: GPIOE_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOF_PORT: GPIOF_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOG_PORT: GPIOG_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;
					 case GPIOH_PORT: GPIOH_AFRL |=(u32) (copy_u8AlT << (4U*copy_u8PIN)); break;		
					 default: break;	
		     }
	...
	else
	{
		  switch (copy_u8PORT)
		  {
			  case GPIOA_PORT: GPIOA_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOB_PORT: GPIOB_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOC_PORT: GPIOC_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOD_PORT: GPIOD_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOE_PORT: GPIOE_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOF_PORT: GPIOF_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOG_PORT: GPIOG_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;
				case GPIOH_PORT: GPIOH_AFRH |=(u32)  (copy_u8AlT << (4*(copy_u8PIN% 8))); break;		
				default: break;	
		  }
